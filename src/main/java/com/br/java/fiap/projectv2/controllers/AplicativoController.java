...
public class AplicativoController {
  ...
  public String inserir(Aplicativo aplicativo, @RequestParam(name = "idUser") int idUser) {
    ...
    aux.append("<br/>");
    aux.append("<br/>");
    aux.append("<a style=\"text-decoration:none;font-size:30px; color:blue \" href=\"http://localhost:8080/aplicativo.html\">Voltar para Aplicativo</a>");
  ...
  public String deletar(@RequestParam(name = "id") int id) {
    ...
    aux.append("<br/>");
    aux.append("<br/>");
    aux.append("<a style=\"text-decoration:none;font-size:30px; color:blue \" href=\"http://localhost:8080/aplicativo.html\">Voltar para Usuario</a>");
    aux.append("</body></html>");
    return aux.toString();
